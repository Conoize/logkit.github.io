...
If `maxFileSizeKiB` is `nil`, the Endpoint will not automatically rotate log files. See [Manual Rotation][manual-rotation] below for information on manually prompting the Endpoint to rotate files.
