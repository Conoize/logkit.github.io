...
The `LXSerialConsoleEndpoint` writes log entries to the console (stdout) on a first-in-first-out basis.
...
The following initializers are available for `LXSerialConsoleEndpoint`:
